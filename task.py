...
FILE_SUFFIX = 'scibert'
#FILE_SUFFIX = 'bert_large'
#FILE_SUFFIX = 'bert_base'
...
class Task:
    ...
    def _load_full_set(self, file_suffix=FILE_SUFFIX):
        '''Returns one Fold. '''
    ...
    def _load_train_dev_test_examples(self, file_suffix=FILE_SUFFIX) -> Fold:
    ...
    def get_all_examples(self, file_suffix=FILE_SUFFIX):
        if self.num_folds == 1:
    ...
    def get_folds_examples(self, file_suffix=FILE_SUFFIX):
